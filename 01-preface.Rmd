...
- There is a confounder $Z$ of $M\rightarrow Y$ affected by treatment assignment
  (adherence)
...
- This shows that associational (regression) mediation does not
  necessarily measure causal mechanisms
