...
#> 1 -0.484   -0.0431  0.397  0.0505 6.56e-16 onestep   direct_natural
```
...
#>   lwr_ci param_est upr_ci var_est eif_mean estimator param           
#>    <dbl>     <dbl>  <dbl>   <dbl>    <dbl> <chr>     <chr>           
#> 1  0.480      1.09   1.70  0.0961 1.52e-15 onestep   indirect_natural
```
...
#>   lwr_ci param_est upr_ci var_est  eif_mean estimator param                
#>    <dbl>     <dbl>  <dbl>   <dbl>     <dbl> <chr>     <chr>                
#> 1 -0.344     0.231  0.806  0.0861 -1.66e-16 onestep   direct_interventional
```
...
#>   lwr_ci param_est upr_ci var_est eif_mean estimator param                  
#>    <dbl>     <dbl>  <dbl>   <dbl>    <dbl> <chr>     <chr>                  
#> 1  0.529      1.07   1.61  0.0765 2.04e-15 onestep   indirect_interventional
```
...
#>   18.749473   19.081534   19.413595    0.028704 -1.1843e-15     onestep
```
